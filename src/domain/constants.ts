...
/**
 * Quote-free Robinhood market universe sent to personalization for each page.
 * Uniswap Explore currently renders roughly 60 Robinhood tokens; keeping the
 * same breadth here prevents the first 30 discovery results from crowding the
 * rest of the market out before ranking.
 */
...
/**
 * Community tokens discovered in live Robinhood Chain liquidity pools. They are
...
/**
 * Deterministic assets used by demo mode and local UI helpers. Live stock
 * discovery never trusts this map: it is built from Robinhood's /rhj/assets
 * chain-4663 deployments and /rhj/prices market data at runtime.
 */
